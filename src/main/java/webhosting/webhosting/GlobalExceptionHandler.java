...
import webhosting.webhosting.login.exception.OAuthUserGenerationException;
import webhosting.webhosting.login.exception.NotLoggedInException;

@ControllerAdvice
public class GlobalExceptionHandler {
    @ExceptionHandler({FileReadException.class, FileSaveException.class, UserNameEncodingException.class, OAuthUserGenerationException.class})
